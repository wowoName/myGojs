    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                { key: "NE", div: "AFC", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军" },
                { key: "NE1", div: "AFC", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军" },

                { key: "DAL", div: "NFC", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军" },

                { key: "NYG", div: "AFCE", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军" },

                { key: "SEA", div: "AFCN", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军" },
            ]
        };
    },
    computed: {},
                ...
                $(go.Node, go.Panel.Auto,
                    ...
                    $(go.Panel, "Vertical",  // the whole node panel
                        ...
                        $(go.Panel, 'Auto',// "Vertical",//Vertical
                            ...
                            //start
                            $(go.Panel, 'Vertical', { fromLinkable: false, padding: 5 },
            ...
            */
            ...
            myDiagram.groupTemplate = // assumes SwimLaneLayout.direction === 0
                $(go.Group, (DIRECTION === 0 || DIRECTION === 180) ? "Horizontal" : "Vertical",
                    ...
                    $(go.Panel, "Auto",
                        $(go.Shape, { fill: "transparent", stroke: "#1890ff", margin: 1, }),
