    ...
    data() {
        return {
            ...
            nodearray: [
                 ...
                 * category 标记开始 结束 节点
                */
                { key: "0", text: "治理意图", bgColor: "#ececec", color: "#ab2f2f", tcolor: "#ffffff", fig: 'RoundedRectangle', "category": "Start" },
                ...
                { key: "5", text: "终止状态标准", parent: 1, level: 4, color: "#ccecff", tcolor: "#000000", "category": "End" },
