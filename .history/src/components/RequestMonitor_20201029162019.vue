...
import go, { Binding, Size } from 'gojs'
var DIRECTION = 90;
    ...
    data() {
        return {
            ...
            nodearray: [
                //大组
                {
                    key: "information", name: "信息功能", isGroup: true, category: "Groups"
                },
                //二级
                { key: "AFC", name: "态势感知", isGroup: true, group: "information" },
                { key: "group", name: "指挥决策", isGroup: true, group: "information" },
                { key: "NFC", name: "行动控制", isGroup: true, group: "information" },
                { key: "AFCE", name: "支援保障", isGroup: true, group: "information" },
                { key: "AFCN", name: "态势感知 ", isGroup: true, group: "information" },
                //三级
                ...
                { key: "NYG", group: "AFCE", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军", deviceType: "边缘指挥车" },

                { key: "SEA", group: "AFCN", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军", deviceType: "边缘指挥车" },

                {
                    key: "commandHierarchy", name: "指挥层级域", isGroup: true
                },
                { key: "c1", name: "XXXX", isGroup: true, group: "commandHierarchy" },
                { key: "c11", group: "c1", title: "XXXX", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军", deviceType: "边缘指挥车" },
            ]
        };
    },
    computed: {},
    ...
    methods: {
        init() {
                                    ...
                                    commitLayers: function (layerRects, offset) {
                                        ...
                                        for (let i = 0; i < this.laneNames.length; i++) {
                                            ...
                                            if (horiz) {
                                                ...
                                                //修改 避免无数据泳道不渲染
                                                let laneAmount = i * 11//Math.max(this.lanePositions.get(lane), 11)
                                                console.log(this.lanePositions.get(lane))
                                            ...
                                            if (horiz) {
                                                ...
                                                //修改 避免无数据泳道不渲染
                                                let laneAmount = Math.max(this.laneBreadths.get(lane), 11)
                                                console.log(this.laneBreadths.get(lane), "------", lane)
            ...
            */
            ...
            myDiagram.groupTemplate.add("Groups",
                goMake(go.Group, "Vertical", {
                    ...
                    layout: goMake(go.GridLayout, // automatically lay out the lane's subgraph
                        {
                            wrappingColumn: null,
            ...
            myDiagram.groupTemplate = goMake(go.Group, (DIRECTION === 0 || DIRECTION === 180) ? "Horizontal" : "Vertical",
                ...
                goMake(go.Panel, "Auto",
                    goMake(go.Shape, { fill: "transparent", stroke: "#1890ff", margin: 10, }),
                    goMake(go.Shape, { name: "PLACEHOLDER", fill: null, stroke: "#1890ff", strokeWidth: 2 })
                ),
