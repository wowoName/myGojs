    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                { key: "5", text: "xxx2", group: "g4", images: "u49.png", parent: 0, color: "#ccecff", tcolor: "#000000", },
    ...
    methods: {
        ...
        getNodeTemplate() {
            return $(go.Node, go.Panel.Auto,
                ...
                $(go.Panel, "Auto",
                    {
                        padding: new go.Margin(0, 30),
                        margin: new go.Margin(0, 0),
                        minSize: new go.Size(130, 80),
                        click: function (a, b) {
                            //   console.log(a, b)
                        },
                    },
                    ...
                    $(go.Picture, {
                        ...
                        width: 30,
                        height: 30,
                        margin: new go.Margin(-50, 0, 0, 120)
                    },
                        new go.Binding("source", (a) => {
