    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                { key: "NE", div: "AFC", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克" },
                ...
                $(go.Node, go.Panel.Auto,
                    ...
                    $(go.Panel, "Vertical",  // the whole node panel
                        ...
                        $(go.Panel, 'Auto',// "Vertical",//Vertical
                            ...
                            //start
                            $(go.Panel, 'Vertical', { fromLinkable: false, padding: 5, minSize: new go.Size(300, 100), },
