...
export default {
    data() {
        return {
            ...
            nodeArray: [
                { key: "1", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", },
                { key: "2", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", },
                { key: "3", itle: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", },
                { key: "4", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", },
                { key: "5", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", },
            ],
            linkArray: [{
                from: 1, to: 2
            }, {
                    ...
                    goMake(go.Panel, "Vertical",  // the whole node panel
                        ...
                        goMake(go.Panel, 'Auto',// "Vertical",//Vertical
                            ...
                            goMake(go.Panel, 'Vertical', {
                                ...
                                setTextNode("title", { font: "15px sans-serif", stroke: "blue", alignment: go.Spot.Left, }),
                                templateLineTwo(),
                                templateLineThree(),
                            ),
                        )
