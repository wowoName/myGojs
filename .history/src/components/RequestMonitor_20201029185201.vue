        ...
        init() {
            ...
            */
            ...
            myDiagram.groupTemplate = goMake(go.Group, (DIRECTION === 0 || DIRECTION === 180) ? "Horizontal" : "Vertical",
                ...
                goMake(go.Panel, "Auto", {
                    margin: 0,
                    padding: new Margin(10, 20, 10, 20)
                },
                    goMake(go.Shape, { fill: "transparent", stroke: "#1890ff", margin: 0 },
                        new Binding("margin", "margin", value => {
                            return value ? value === "left" ? new go.Margin(0, 0, 0, 100) : value === "right" ? new go.Margin(0, 100, 0, 0) : 0 : 0
                        })
                    ),
                    goMake(go.Shape, { name: "PLACEHOLDER", fill: null, stroke: "#1890ff", strokeWidth: 1, margin: 0 })
                )
