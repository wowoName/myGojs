    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                { key: "AFCE", name: "支援保障end", isGroup: true, group: "g1", margin: [0, 10, 0, 0] },
                //三级
                ...
                { key: "AFC1", name: "态势感知", isGroup: true, group: "g2", margin: [0, 0, 0, 10] },
                ...
                goMake(go.Panel, "Auto", {
                    ...
                    goMake(go.Shape, { fill: "transparent", stroke: "#1890ff", margin: 0 },
                        new Binding("margin", "margin", value => {
                            return value ? new go.Margin(value.join(",")) : 0
                        })
                    ),
