    ...
    data() {
        return {
            ...
            nodearray: [
                 ...
                 * category 标记开始 结束 节点
                */
                { key: "g1", text: "xx", isGroup: true, },
                { key: "g2", text: "xx", isGroup: true, },
                { key: "g3", text: "xx", isGroup: true, },
                { key: "g4", text: "xx", isGroup: true, },


                { key: "0", text: "xx", group: "g1", images: "u6.png", bgColor: "#ececec", color: "#ab2f2f", tcolor: "#ffffff", group: "g2", fig: 'RoundedRectangle', "category": "Start" },
                { key: "1", text: "xx", group: "g3", images: "u7.png", parent: 0, color: "#2c82d4", tcolor: "#ffffff", fig: 'RoundedRectangle' },
                { key: "2", text: "xx", group: "g4", images: "u19.png", parent: 1, color: "#fa9653", tcolor: "#ffffff", fig: 'RoundedRectangle' },
                { key: "3", text: "大是大非", group: "g1", images: "u48.png", parent: 2, color: "#ffffff", tcolor: "#000000" },
                { key: "4", text: "xxx", group: "g1", images: "u6.png", parent: 0, color: "#ccecff", tcolor: "#000000", },
            ...
            return $(go.Node, go.Panel.Auto,
                ...
                $(go.Panel, "Auto",
                    ...
                    $(go.Picture, {
                        ...
                        width: 30,
                        height: 30,
                        margin: new go.Margin(-50, 0, 0, 100)
                    },
                        new go.Binding("source", (a) => {
            ...
            this.myDiagram.nodeTemplateMap.add("Bands",
                $(go.Part, "Position",
                    new go.Binding("itemArray"),
                    {
                        ...
                        locationSpot: new go.Spot(0, 0, 150, 0),
