    ...
    data() {
        return {
            ...
            nodearray: [
                 ...
                 * category 标记开始 结束 节点
                */
                { key: "0", text: "治理意图", bgColor: "#ececec", level: 0, color: "#ab2f2f", tcolor: "#ffffff", fig: 'RoundedRectangle', "category": "Start" },
                ...
                { key: "5", text: "终止状态标准", parent: 0, level: 2, color: "#ccecff", tcolor: "#000000", "category": "End" },
    ...
    methods: {
        ...
        getNodeTemplate() {
            return $(go.Node, go.Panel.Auto,
                ...
                $(go.Panel, "Auto",
                    {
                        padding: new go.Margin(0, 0, 0, 100),
