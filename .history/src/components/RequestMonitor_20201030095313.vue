    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                //第二组
                { key: "g2", name: "指挥层级域", category: "Parallel", isGroup: true, },
                { key: "AFC1", name: "平台", isGroup: true, group: "g2", margin: "left" },
                { key: "group1", name: "武器", isGroup: true, group: "g2" },
                { key: "NFC1", name: "战术", isGroup: true, group: "g2" },
                { key: "AFCE1", name: "战役", isGroup: true, group: "g2" },
                { key: "AFCN1", name: "战略 ", isGroup: true, group: "g2" },

                { key: "key1", group: "AFC1", title: "态势上报", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "空军", deviceType: "预警机" },

                { key: "key2", group: "AFCE1", title: "态势上报end", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军", deviceType: "边缘指挥车" },
                { key: "key3", group: "AFCN1", title: "态势上报end", version: "v1.0", tag: "战略", tagDesc: "态势感知", services: "海军", deviceType: "边缘指挥车" },
                                    ...
                                    commitLayers: function (layerRects, offset) {
                                        ...
                                        for (let i = 0; i < this.laneNames.length; i++) {
                                            ...
                                            if (horiz) {
                                                ...
                                                ph.desiredSize = new go.Size(this.laneBreadths.get(lane) * this.columnSpacing + offsetX, totallength);
                                            }
                                        }
                                    }
                                })
            ...
            */
            ...
            myDiagram.groupTemplate = goMake(go.Group, (DIRECTION === 0 || DIRECTION === 180) ? "Horizontal" : "Vertical",
                ...
                goMake(go.Panel, "Auto", {
                    ...
                    goMake(go.Shape, { fill: "transparent", stroke: null, margin: 0 },

                    ),
                    goMake(go.Shape, { name: "PLACEHOLDER", fill: null, stroke: "#00519c", strokeWidth: 1, margin: 0 })
                )
