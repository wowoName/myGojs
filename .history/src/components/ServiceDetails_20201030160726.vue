...
export default {
    data() {
        return {
            ...
            nodeArray: [
                { key: "1", title: "态势上报", version: "v11.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", status: 0 },
                { key: "2", title: "态势上报", version: "v12.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", status: 0 },
                { key: "3", title: "态势上报", version: "v13.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", status: 1 },
                { key: "4", title: "态势上报", version: "v14.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", status: 1 },
                { key: "5", title: "态势上报", version: "v15.0", tag: "战略", tagDesc: "态势感知", services: "陆军", deviceType: "坦克指挥", servicesUrl: "service_target identification", status: 2 },
            ],
            linkArray: [{
                from: 1, to: 2
            }, {
            ...
            function templateLineThree() {
                return goMake(go.Panel, "Auto", {
                    ...
                    goMake(go.Panel, "Horizontal", {
                        ...
                        // setTextNode("status", { margin: new go.Margin(0, 20, 0, 0) }),
                        goMake(go.TextBlock,
                            getTextStyle({ margin: new go.Margin(0, 10, 0, 0) }),
                            new go.Binding("text", "status", value => {
                                return value === 0 ? "空" : "忙"
                            }),
                            new go.Binding("stroke", "status", value => {
                                return value === 0 ? "#35dc0b0f" : "#ed07070f"
                            }),
                        ),
                        ...
                        setTextNode("services", { margin: new go.Margin(0, 20, 0, 0) }),
