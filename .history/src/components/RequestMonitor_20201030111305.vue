            ...
            */
            ...
            myDiagram.groupTemplate = goMake(go.Group, (DIRECTION === 0 || DIRECTION === 180) ? "Horizontal" : "Vertical",
                ...
                goMake(go.Panel, "Auto", {
                    ...
                    goMake(go.Shape, { fill: "transparent", stroke: "red", margin: new go.Margin(0, -40, 0, 0) },

                    ),
                    goMake(go.Shape, { name: "PLACEHOLDER", fill: null, stroke: "#00519c", strokeWidth: 1, margin: new go.Margin(0, -40, 0, 0) })
                )
