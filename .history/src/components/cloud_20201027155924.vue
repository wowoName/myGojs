    ...
    data() {
        return {
            ...
            nodearray: [
                 ...
                 * category 标记开始 结束 节点
                */
                { key: "0", text: "治理意图", images: "u6.png", bgColor: "#ececec", color: "#ab2f2f", tcolor: "#ffffff", fig: 'RoundedRectangle', "category": "Start" },
                { key: "1", text: "治理目的", images: "u7.png", parent: 0, color: "#2c82d4", tcolor: "#ffffff", fig: 'RoundedRectangle' },
                { key: "2", text: "治理方针", images: "u19.png", parent: 1, color: "#fa9653", tcolor: "#ffffff", fig: 'RoundedRectangle' },
                { key: "3", text: "终止状态", images: "u6.png", parent: 2, color: "#ffffff", tcolor: "#000000" },
                { key: "5", text: "终止状态标准", images: "u6.png", parent: 0, color: "#ccecff", tcolor: "#000000", "category": "End" },
