        ...
        init() {
            ...
            myDiagram.model = new go.GraphLinksModel(
                [ // node data
                    ...
                    { key: "Pool11", text: "Pool", isGroup: true, category: "Pool1" },
                    { key: "Lane11", text: "Lane1", isGroup: true, group: "Pool11", color: "lightblue" },
                    { key: "Lane21", text: "Lane2", isGroup: true, group: "Pool11", color: "lightgreen" },
                    { key: "Lane31", text: "Lane3", isGroup: true, group: "Pool11", color: "lightyellow" },
                    { key: "Lane41", text: "Lane4", isGroup: true, group: "Pool11", color: "orange" },
