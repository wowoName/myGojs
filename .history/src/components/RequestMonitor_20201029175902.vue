...
import ParallelLayout from '@/utils/parallelLayout'
...
export default {
    ...
    data() {
        return {
            ...
            nodearray: [
                { key: "g1", name: "一个大组的内容", category: "Split", isGroup: true, },
                //二级
                ...
                //第二组
                { key: "g2", name: "第二组", category: "Split", isGroup: true, },
    ...
    methods: {
        init() {
            ...
            */
            ...
            myDiagram.groupTemplateMap.add("Split",
                goMake(go.Group, "Auto",
                    {
                        ...
                        layout: goMake(ParallelLayout, { layerSpacing: 20, nodeSpacing: 10 }),
                        avoidable: false,
