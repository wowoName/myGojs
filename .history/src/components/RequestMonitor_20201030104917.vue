    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                { key: "AFCE", name: "支援保障end", isGroup: true, group: "g1" },
                //三级
                ...
                { key: "AFC1", name: "平台", isGroup: true, group: "g2" },
            ...
            let myDiagram =
                goMake(go.Diagram, "myDiagramDiv",
                    { // automatically scale the diagram to fit the viewport's size
                        ...
                        initialAutoScale: Diagram.scale,
            ...
            myDiagram.nodeTemplate =
                goMake(go.Node, go.Panel.Auto,
                    ...
                    goMake(go.Panel, "Vertical",  // the whole node panel
                        ...
                        //     return value === 'information' ? new go.Margin(0, 0, 30, 0) : new go.Margin(0, 0, 30, 120)
                        // }),
