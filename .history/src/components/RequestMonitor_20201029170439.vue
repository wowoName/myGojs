...
export default {
    ...
    data() {
        return {
            ...
            nodearray: [
                { key: "g1", name: "一个大组的内容", category: "Pool", isGroup: true, },
                //二级
                { key: "AFC", name: "态势感知", isGroup: true, group: "g1" },
                { key: "group", name: "指挥决策", isGroup: true, group: "g1" },
                { key: "NFC", name: "行动控制", isGroup: true, group: "g1" },
                { key: "AFCE", name: "支援保障", isGroup: true, group: "g1" },
                { key: "AFCN", name: "态势感知 ", isGroup: true, group: "g1" },
                //三级
                ...
                //第二组
                { key: "g2", name: "第二组", category: "Pool", isGroup: true, },

                { key: "AFC", name: "态势感知", isGroup: true, group: "g1" },
                { key: "group", name: "指挥决策", isGroup: true, group: "g2" },
                { key: "NFC", name: "行动控制", isGroup: true, group: "g2" },
                { key: "AFCE", name: "支援保障", isGroup: true, group: "g2" },
                { key: "AFCN", name: "态势感知 ", isGroup: true, group: "g2" },
            ]
        };
    },
    computed: {},
