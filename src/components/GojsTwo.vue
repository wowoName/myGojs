    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                {
                    key: "root", text: "初始状态", color: "#f44336", tcolor: "#ececec",
                    fields: [
                        { name: "阶段目标", info: "1、手动蝶阀收水电费水电费单水电费水电费是2、水电费水电费第三方士大夫收到1、手动蝶阀收水电费水电费单水电费水电费是2、水电费水电费第三方士大夫收到", color: "#F7B84B", figure: "Ellipse" },
                        { name: "达成条件", info: "第二列", color: "#F25022", figure: "Ellipse" },
                        { name: "fieldThree", info: "第三列", color: "#00BCF2" }
                    ],
                },

                {
                    ...
                    fields: [
                        ...
                        { name: "达成条件", info: "一段文字描述", color: "#F25022", figure: "Ellipse" },
                ...
                {
                    key: "threeA", parent: "twoA", text: "XXX4", color: "#009688", tcolor: "#ffffff",
                    fields: [
                        { name: "阶段目标", info: "", color: "#F7B84B", figure: "Ellipse" },
                        { name: "达成条件", info: "一段文字描述", color: "#F25022", figure: "Ellipse" },
                        { name: "fieldThree", info: "3rd", color: "#00BCF2" }
                ...
                {
                    key: "fourA", parent: "threeA", text: "XXX6", color: "#ffc107", tcolor: "#ffffff",
                    fields: [
                        { name: "阶段目标", info: "", color: "#F7B84B", figure: "Ellipse" },
                        { name: "达成条件", info: "一段文字描述", color: "#F25022", figure: "Ellipse" },
                        { name: "fieldThree", info: "3rd", color: "#00BCF2" }
                ...
                {
                    key: "five", parent: "fourA", text: "xxx", color: "#344094", tcolor: "#ffffff",
                    fields: [
                        { name: "阶段目标", info: "", color: "#F7B84B", figure: "Ellipse" },
                        ...
                        $(go.Panel, "Table",
                            {
                                ...
                                itemTemplate: $(go.Panel, "TableColumn",  // this Panel is a row in the containing Table
                                    ...
                                    $(go.TextBlock,
                                        {
                                            margin: new go.Margin(0, 0), row: 1, font: "bold 13px sans-serif",
                                            alignment: go.Spot.Center,
                                            width: 100,
