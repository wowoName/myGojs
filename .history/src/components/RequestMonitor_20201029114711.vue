            ...
            function templateLineTwo() {
                return $(go.Panel, "Auto",
                    $(go.Panel, "Horizontal",
                        ...
                        $(go.Panel, "auto",
                            $(go.Shape, "RoundedRectangle",
                                { fill: "#ececec", stroke: "#D8D8D8", width: 80, height: 50, }),
                            $(go.TextBlock,
                                { margin: 5, width: 80, height: 50, font: "bold 12pt Helvetica, bold Arial, sans-serif", verticalAlignment: go.Spot.Center },
