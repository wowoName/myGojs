...
export default {
    ...
    data() {
        return {
            ...
            nodearray: [
                ...
                { key: "interval", isGroup: true, group: "g1", category: "Interval" },

                //第二组
                { key: "g2", name: "第二组", category: "Parallel", isGroup: true, },
                { key: "AFC1", name: "态势感知", isGroup: true, group: "g2", margin: "left" },
    ...
    methods: {
        init() {
            ...
            myDiagram.nodeTemplateMap.add("Interval",
                goMake(go.Node, "Spot",
                    goMake(go.Panel, 'Auto', {
            ...
            */
            ...
            function dealEmptyGroup() {
                ...
                let defaultLane = [...new Set(that.nodearray.filter(v => Object.prototype.hasOwnProperty.call(v, 'group') && !Object.prototype.hasOwnProperty.call(v, 'category')).map(v => v.group))]
                //空组
